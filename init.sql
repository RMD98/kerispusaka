...
-- Dumping data for table dkppp.migrations: ~15 rows (approximately)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(16, '2025_08_11_042355_create_ticket', 2);
...
-- Dumping data for table dkppp.peternak: ~12 rows (approximately)
...
-- Dumping data for table dkppp.staff: ~5 rows (approximately)
DELETE FROM `staff`;
...
INSERT INTO `staff` (`id_staff`, `nama`, `email`, `no_hp`, `jabatan`, `alamat`, `created_at`, `updated_at`) VALUES
	...
	('STAFF-2025-0004', 'Lela Nurlela', 'lela.nurlela@gmail.com', '081234682244', 'dokter', 'Pintusinga', NULL, NULL),
	('STAFF-2025-0005', 'Bella', 'Bella@gmail.com', '081387838378', 'dokter', 'Banjar', NULL, NULL),
	('STAFF-2025-0006', 'Desqi', 'desqi@gmail.com', '087738835553', 'dokter', 'Banjar', NULL, NULL),
	('STAFF-2025-0007', 'Hanif', 'hanif@gmail.com', '081386986433', 'dokter', 'Banjar', NULL, NULL);
...
-- Dumping data for table dkppp.ticket: ~6 rows (approximately)
DELETE FROM `ticket`;
/*!40000 ALTER TABLE `ticket` DISABLE KEYS */;
INSERT INTO `ticket` (`id_ticket`, `id_user`, `jenis_laporan`, `status`, `created_at`, `updated_at`) VALUES
	('TKT-1754893047', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754893580', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754893615', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754893638', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754893642', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754893647', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL),
	('TKT-1754895754', 'PETERNAK-2025-0001', 'Admin', 'open', NULL, NULL);
...
-- Dumping data for table dkppp.users: ~20 rows (approximately)
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `user_name`, `email`, `email_verified_at`, `password`, `role`, `remember_token`, `id_user`, `created_at`, `updated_at`) VALUES
	...
	(3, 'test_user', 'xydu@mailinator.com', NULL, '$2y$12$f72Zxn/OX7ve63HVZaPHb.K6YDvppjdpd3aDrxoFZgLfuPEV0kkp.', 'peternak', NULL, 'PETERNAK-2025-0001', NULL, NULL),
	...
	(18, 'lela', 'lela.nurlela@gmail.com', NULL, '$2y$12$IOvCGjn9/e8bmEVdsx/Uu.e.4xxPOUbzQnn6Tc.3nMay7LLszyDYW', 'dokter', NULL, 'STAFF-2025-0004', NULL, NULL),
	(19, 'bella', 'Bella@gmail.com', NULL, '$2y$12$8IeMgs7G3RgKjQ2YVsrOt.P9ER70Cr7CmngbMyzujDslsZpB2OYGy', 'dokter', NULL, 'STAFF-2025-0005', NULL, NULL),
	(20, 'desqi', 'desqi@gmail.com', NULL, '$2y$12$uTbYHj/pHDKA823aQ1Bfu.ZajJH4Q01828kmaYiIAJ85/DVaBVSca', 'dokter', NULL, 'STAFF-2025-0006', NULL, NULL),
	(21, 'hanif', 'hanif@gmail.com', NULL, '$2y$12$p0alkEB2/ky2kPlKX6e.vuSPqp9jpAPSGtQ2US0Ommz79/878y04y', 'dokter', NULL, 'STAFF-2025-0007', NULL, NULL);

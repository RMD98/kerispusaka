...
<div class="bg-white w-full shadow rounded-2xl p-4">
    ...
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-xl font-semibold text-gray-800">Tambah Inseminasi Buatan</h3>
    </div>
    ...
    <form action="" method="POST" class="flex-1 overflow-auto space-y-6">
                ...
                <div>
                    ...
                    <select id="staff" name="staff" class="w-full rounded-lg shadow-sm border border-gray-300" required>
                    </select>
                </div>
                <div>

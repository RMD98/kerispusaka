<footer id="footer" class="footer dark-background">
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('/vendor/home/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{asset('/vendor/home/php-email-form/validate.js')}}"></script>
  <script src="{{asset('/vendor/home/aos/aos.js')}}"></script>
